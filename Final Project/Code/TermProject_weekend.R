...
#============================Obtaining Data============================#
weekend <- x[which(!weekdays(as.Date(x$Date, format = "%d/%m/%Y"))
...
days_training <- subset(weekend, weekend$Date >= as.POSIXlt("16/12/2006", format = "%d/%m/%Y") & weekend$Date <= as.POSIXlt("31/12/2008", format = "%d/%m/%Y"))
days_testing <- subset(weekend, weekend$Date >= as.POSIXlt("1/1/2009", format = "%d/%m/%Y") & weekend$Date <= as.POSIXlt("1/12/2009", format = "%d/%m/%Y"))
...
anomalyData1 <- anomalyData1[which(!weekdays(as.Date(x$Date, format = "%d/%m/%Y")) %in% c ('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday')), ]
anomalyData1 <- subset(anomalyData1, anomalyData1$Time >= as.POSIXlt("8:00:00", format = "%H:%M:%S") & anomalyData1$Time <= as.POSIXlt("15:00:00", format = "%H:%M:%S"))
...
#getting the weekdays in the anomaly data, 4-11pm
anomalyData2 <- anomalyData2[which(!weekdays(as.Date(x$Date, format = "%d/%m/%Y")) %in% c ('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday')), ]
anomalyData2 <- subset(anomalyData2, anomalyData2$Time >= as.POSIXlt("8:00:00", format = "%H:%M:%S") & anomalyData2$Time <= as.POSIXlt("15:00:00", format = "%H:%M:%S"))
...
#getting the weekdays in the anomaly data, 4-11pm
anomalyData3 <- anomalyData3[which(!weekdays(as.Date(x$Date, format = "%d/%m/%Y")) %in% c ('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday')), ]
anomalyData3 <- subset(anomalyData3, anomalyData3$Time >= as.POSIXlt("8:00:00", format = "%H:%M:%S") & anomalyData3$Time <= as.POSIXlt("15:00:00", format = "%H:%M:%S"))
